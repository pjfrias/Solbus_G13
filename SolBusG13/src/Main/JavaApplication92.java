...
public class JavaApplication92 {
    ...
    public static void main(String[] args) {
        ...
        Colectivo uno = new Colectivo("aaa123", "ford", "uno", 32, true);
        Ruta primera = new Ruta("villa merceds","san luis", LocalTime.of(1, 10), true);
        Horario primer = new Horario(LocalTime.of(13, 0), LocalTime.of(14,10), primera, true);
        Pasajero nuevo = new Pasajero("juan","manuel", "12222222", "tucorreo@correo.com", "2657111111", true);
        Pasaje pasaje = new Pasaje(nuevo, uno, primera, LocalDate.of(2024, 6, 8), LocalTime.of(13, 0), 0, 0, true);
        ...
        Colectivo modificado = new Colectivo("aaa123", "chevrolet", "uno", 32, true);
        ...
        Pasajero pasajero = new Pasajero("juan","Torres", "12222222", "tucorreo@correo.com", "2657111111", true);
        ...
        Ruta modificada = new Ruta("villa merceds","Merlo", LocalTime.of(1, 10), true);
        datosRuta.editarRutaporId(primera);
        ...
        System.out.println(horarios.buscarHorariosID(1));
        Horario modificarHorario = new Horario(LocalTime.of(13, 0), LocalTime.of(14,10), modificada, true);
        ...
        Pasaje pasajedos = new Pasaje(nuevo, uno, primera, LocalDate.of(2024, 7, 8), LocalTime.of(13, 0), 0, 0, true);
        pasajes.modificarPasaje(pasajedos);
        pasajes.eliminarPasaje(0);      
    }
}